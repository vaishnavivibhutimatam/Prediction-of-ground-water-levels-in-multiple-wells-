...
main = tkinter.Tk()
main.title("forecasting of ground water level in multiple wells using machine learning models")
...
def GUI():
    ...
    font = ('times', 16, 'bold')
    title = Label(main, text='forecasting of ground water level in multiple wells using machine learning models')
